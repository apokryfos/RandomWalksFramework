...
namespace RandomWalkFramework.Analysis {
	...
	public delegate void LoggingEvent<TVertex>(RandomWalkLogger<TVertex> obj, string logPath);


	public interface IRandomWalkLogger<TVertex> : IDisposable {
		...
		event LoggingEvent<TVertex> FinishedLogging;
	}

	public class RandomWalkBinaryLogger<TVertex> : RandomWalkLogger<TVertex>, IRandomWalkLogger<TVertex> {
	...
	public class RandomWalkLogger<TVertex> : IRandomWalkLogger<TVertex> {
		...
		public event LoggingEvent<TVertex> FinishedLogging;
